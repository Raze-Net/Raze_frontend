...
class ClientBase {
    ...
    */
    async redeem (value, redeemGasLimit) {
        ...
        console.log("Client round: ", state.lastRollOver);
    ...
    */
    async transfer (receiver, value, decoys, transferGasLimit) {
        ...
        */
        ...
        // console.log("Raze balance: ", (await this.web3.eth.getBalance(that.raze.options.address)));
        // console.log("Agency balance: ", (await this.web3.eth.getBalance(await that.raze.methods.razeAgency().call())));
